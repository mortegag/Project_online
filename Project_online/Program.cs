        ...
        private ProjectContext context;
            ...
            public void SetCustomField(string userEmail, string newValue = "")
            {
                ...
                if (user != null)
                {
                    ...
                    // not that we are doing a string match here to figure out the internal name of the value in the lookup table
                    var entryInternalName = AllCustomFields[CustomFieldGuid].LookupEntries[newValue].InternalName;  
