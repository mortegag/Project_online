...
#pragma warning disable CS0234 // El tipo o el nombre del espacio de nombres 'SharePoint' no existe en el espacio de nombres 'Microsoft' (¿falta alguna referencia de ensamblado?)
using Microsoft.SharePoint.Client;
#pragma warning restore CS0234 // El tipo o el nombre del espacio de nombres 'SharePoint' no existe en el espacio de nombres 'Microsoft' (¿falta alguna referencia de ensamblado?)
#pragma warning disable CS0234 // El tipo o el nombre del espacio de nombres 'ProjectServer' no existe en el espacio de nombres 'Microsoft' (¿falta alguna referencia de ensamblado?)
using csom = Microsoft.ProjectServer.Client;
#pragma warning restore CS0234 // El tipo o el nombre del espacio de nombres 'ProjectServer' no existe en el espacio de nombres 'Microsoft' (¿falta alguna referencia de ensamblado?)
